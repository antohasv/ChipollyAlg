...
public class PolinomComputition {
    ...
    public static int solveSystem(BinaryPolinom binaryPolinom, int x, int mod) {
        return Mod.compute(binaryPolinom.getA() * x * x + binaryPolinom.getB() * x + binaryPolinom.getC(), mod);
    }
}
